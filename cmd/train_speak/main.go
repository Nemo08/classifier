...
import "github.com/Nemo08/classifier/datasets/speak"
...
func main() {
	...
	evaluate := func() (int, [32]byte) {
		...
		success := 100 * int(percent.Load()) / (int(total.Load()) / parts)
